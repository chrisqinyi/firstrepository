...
import com.beeInvestment.application.PaymentRolledBackEvent;
...
public class Payment extends BaseAggregateRoot{
	...
	Payment(AggregateId aggregateId, CustomerData customerData, Money amount) {
	...
	public Payment rollBack(){
		...
		return paymentFactory.createPayment(customerData, amount.multiplyBy(-1));
	}
}
